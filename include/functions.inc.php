...
function invalidSex($sex)
{
    if (!preg_match("/^[a-zA-Z0-9]*$/", $sex)) {
        $result = true;
    } else {
        $result = false;
    }
...
function invalidQualification($Qualification)
{
    if (!preg_match("/^[a-zA-Z0-9]*$/", $Qualification)) {
        $result = true;
    } else {
        $result = false;
    }
...
function invalidSpecialization($Specialization)
{
    if (!preg_match("/^[a-zA-Z0-9]*$/", $Specialization)) {
        $result = true;
    } else {
        $result = false;
    }
